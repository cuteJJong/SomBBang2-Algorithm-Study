...
제한사항
-record는 다음과 같은 문자열이 담긴 배열이며, 길이는 1 이상 100,000 이하이다. //O(NlogN)으로 풀어야한다
...
*
-풀이
기존의 어떤 닉네임을 썼는지 보다는 마지막에 썼던 닉네임을 확인하자
시간 복잡도 O(NlogN)
HashMap이 알아서 바뀐거 고쳐줌
for문 한번으로 최종 아이디 구해서 저장 O(N)안에
다음 for문으로 Enterm Leave, Change일 때 ```님이 들어왔습니다 찾아서 닉네임 붙여주기
*
* */
public class Exam01 {
    ...
    public static void main(String[] args) {
        ...
        String[] result = exam.solution(record);
