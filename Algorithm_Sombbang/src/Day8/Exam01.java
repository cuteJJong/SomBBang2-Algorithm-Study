...
제한사항
입국심사를 기다리는 사람은 1명 이상 1,000,000,000명 이하입니다. -> O(N) 시간 초과
각 심사관이 한 명을 심사하는데 걸리는 시간은 1분 이상 1,000,000,000분 이하입니다. -> O(N) 시간 초과  100,000 * log(10억*10억) = 약 600만(long)
심사관은 1명 이상 100,000명 이하입니다. -> O(NlogN), O(N)
